...
const styles = sortCx({
    ...
    modern: {
        ...
        colors: {
            brand: "text-featured-icon-light-fg-brand",
            gray: "text-fg-secondary ring-primary",
            error: "text-featured-icon-light-fg-error",
            warning: "text-featured-icon-light-fg-warning",
            success: "text-featured-icon-light-fg-success",
        },
    },
    "modern-neue": {
        base: [
