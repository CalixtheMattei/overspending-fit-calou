...
interface FileUploadDropZoneProps {
    ...
    /**
     * Render prop for custom dropzone content.
     */
    children?: (props: { openFileDialog: () => void; isDraggingOver: boolean; isDisabled: boolean }) => ReactNode;
}
...
export const FileUploadDropZone = ({
    ...
    const content =
        typeof children === "function" ? (
            children({ openFileDialog, isDraggingOver, isDisabled: Boolean(isDisabled) })
        ) : (
            <>
                ...
                <div className="flex flex-col gap-1 text-center">
                    <div className="flex justify-center gap-1 text-center">
                        <Button color="link-color" size="md" isDisabled={isDisabled} onClick={openFileDialog}>
...
export interface FileListItemProps {
    ...
    onRetry?: () => void;
    /** Optional label for completed uploads. */
    completeLabel?: string;
    /** Optional label for in-progress uploads. */
...
export const FileListItemProgressBar = ({
    ...
    const completeText = completeLabel ?? "Complete";
    const inProgressText = inProgressLabel ?? "Uploading...";
                    ...
                    <div className="min-w-0 flex-1">
                        ...
                        <div className="mt-0.5 flex items-center gap-2">
                            ...
                            <div className="flex items-center gap-1">
                                ...
                                {isComplete && <p className="text-sm font-medium text-success-primary">{completeText}</p>}

                                {!isComplete && !failed && <UploadCloud02 className="size-4 stroke-[2.5px] text-fg-quaternary" />}
                                {!isComplete && !failed && <p className="text-sm font-medium text-quaternary">{inProgressText}</p>}
